...
@sython.on(events.NewMessage(outgoing=False, pattern='عمك'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك عمر ابشر  @isomaar')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | OMAR TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
      await event.reply("""السـورس يعمـل |عمر
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
